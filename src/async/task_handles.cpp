...
void asyncInfraInit() {
    ...
    if (g_netCmdQueue == nullptr || g_displayCmdQueue == nullptr || g_audioCmdQueue == nullptr || g_mqttClientMutex == nullptr ||
        g_chayaPublishMutex == nullptr || g_heartDebounceMutex == nullptr || g_nvsMutex == nullptr ||
